---
title: "Clinical Trial Analysis of Hypertension Treatments"
author: "Reina Kaino"
date: "2025-12-03"
format:
  html:
...
```{r }
df <- read.csv("data/synthetic_clinical_trial_data.csv")
...
```{r age_cholesterol_box, echo=FALSE}
...
```{r age_systolic, echo=FALSE}
plot(x = df$Age, y = df$Systolic_BP)

```

```{r age_systolic_box, echo=FALSE}
